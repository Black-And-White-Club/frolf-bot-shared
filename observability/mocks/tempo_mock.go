...
// Source: observability/tempo/tempo.go
//
// Generated by this command:
//
//	mockgen -source=observability/tempo/tempo.go -destination=observability/mocks/tempo_mock.go -package=mocks
//
...
func (m *MockTracer) InitTracing(ctx context.Context, opts tempofrolfbot.TracingOptions) (func(), error) {
	m.ctrl.T.Helper()
